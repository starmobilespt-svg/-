...
# 📥 Bot ထဲသို့ Backup ဖိုင် (`accounting.db`) တိုက်ရိုက်တင်၍ Restore လုပ်ရန်
...
def restore_backup(message):
    if message.document.file_name == 'accounting.db':
        try:
            ...
            # Database အဟောင်းနေရာတွင် အစားထိုးသိမ်းဆည်းခြင်း
...
print("Accounting Bot with Restore feature is running successfully...")
